                ...
                <Container >
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        <Nav className='navbar-items'>
                            <Nav.Link className="all-items" ><Link to="/Courses" style={{textDecoration:"none",color:"gray"}}>Courses</Link></Nav.Link>
                            ...
                            <Nav.Link className="all-items" href="#"><Link to="#" style={{ textDecoration: "none", color: "#707071" }}>Business</Link></Nav.Link>
