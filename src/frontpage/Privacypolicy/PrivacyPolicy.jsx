        ...
        <div className='PrivacyPolicy'>
            ...
            <h3>Privacy Policy</h3>
                ...
                <ul>
                    ...
                    <li> To protect against imminent harm to the rights, property or safety of the Application/Website/ EduMetrix.io or its users or the public as required or permitted by law;</li>
                    <li> With third party service providers in order to personalize the Application/Website for a better user experience and to perform behavioural analysis;</li>
                </ul>
                <p>
                ...
                <p>
                    Reach out to us on <a href="mailto:support@edumetrix.io">support@edumetrix.io</a>, in case of any queries.
                </p>
            </div>
        </div >
        <Footer/>
