  ...
  return (
    <div className="full-hr-page">
      ...
      <div className="Hr-information">
        <div className="hr-information-1">
          ...
          <div className="hr-info-paragraph">
            ...
            JavaScript Developer, which helps to simplify your hiring process.
            We also provide superior hands on practice with the ability to
            deliver desired results that has always helped them to stay focused.
            We have a team of dedicated and professional HR consultants who will
            guide you through the hiring process from the scratch. Whether it is
            an MNC, a Startup or a Medium-sized organization, we have
            tailor-made packages catering to all your requirements.
          </div>
        </div>

        <div className="hr-information-2">
          <div className="hr-information-21">
          ...
          <div className="hr-information-21">
            ...
            <div className="hr-info-paragraph">
              ...
              FIRM, we make them work on real projects guiding them in front
              end, back end, server technologies and train them as a full stack
              developer and also help them in making own projects. <br />
              Candidates who gets trained in our firm will be expertise on
              coding related to Front end (HTML, CSS, JavaScript, React and
              React Native), Back end (Node, JavaScript and My SQL/MongoDB),
              Server end (Azure/Github). <br />
              ...
              <br />
              Our emotive effort is to bridge the gap between job seekers and
              job providers .
            </div>
          </div>
        </div>
