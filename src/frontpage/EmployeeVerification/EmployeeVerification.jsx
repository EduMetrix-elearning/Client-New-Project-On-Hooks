        ...
        <div className="all-agent-Card-page">
          <Card className="one-agent-card">
            ...
            <CardContent className="card_container">
              ...
              >
                <i className="fa fa-globe mr-2"></i> Jamsherjamshi1998@gmail.com
              </Typography>
              <Typography
                className="card_detail"
                variant="body2"
                color="text.secondary"
              >
                <i className="fa fa-phone mr-2"></i> 9880686768
              </Typography>
              <Typography
                className="card_detail"
                variant="body2"
                color="text.secondary"
              >
                <i className="fa fa-phone mr-2"></i>O +VE
              </Typography>
              <Typography
                className="card_detail"
                variant="body2"
