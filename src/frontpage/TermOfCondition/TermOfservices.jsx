        ...
        <div className='TermsOfServices'>
            ...
            <h3>Terms of services</h3>
               <div className='paragraph-article'> 
                <p>These Terms & Conditions (“Terms”) of (a) use of our website www.eduemetrix.io (“Website”), our applications (“Application”) are between EduMetrix.io (“Company/We/Us/Our”) and its users (“User/You/Your”).</p>
                <p>Please read the Terms and the privacy policy of the Company (“Privacy Policy”) with respect to registration with us, the use of the Application, Website, Services and products carefully before using the Application, Website and Services. In the event of any discrepancy between the Terms and any other policies with respect to the Application or Website or Services, the provisions of the Terms shall prevail.</p>
                <p>
