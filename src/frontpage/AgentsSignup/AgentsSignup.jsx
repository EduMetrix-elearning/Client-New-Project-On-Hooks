...
export const AgentsSignup = () => {
  ...
  const handlesignUpSubmit = (e) => {
    ...
    if (name === "") {
      ...
      flag = true
      setErrorPhone("phone number not valid Or enter the phone number with zip code*")
    }
    ...
    else if (password && password != undefined && ((password.split(" ").length - 1) > 0)) {
      flag = true
    ...
    if(!flag){
      ...
      services.agentSignup(obj,(error,result)=>{
        console.log("Inside Agent service Varification")
        if(result){
