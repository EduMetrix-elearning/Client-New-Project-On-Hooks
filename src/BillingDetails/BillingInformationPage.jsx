  ...
  const handleinvoiceForm = () => {
    try {
      if (
        ...
        const submitBill = async (bills) => {
          await services.submitStudentBill(bills);
        };
        submitBill(bill);
    ...
    <div className="billing-pages-main-div">
      ...
      <div className="billed-by-to-div">
        <div className="billed-by">
          ...
          <p>
            #5, 3rd floor, Dr, Sir M. Visvesvaraya Rd, off Bannarghatta Main{" "}
            <br /> Road, Bangalore, <br /> Karnataka,India-560076
          </p>
          <p>
            <span style={{ fontWeight: "bold" }}>GSTIN</span>:29AAFCE5813R1ZZ
          </p>
          <p>
            <span style={{ fontWeight: "bold" }}>PAN</span>:AAFCE5813R
          </p>
        </div>
        ...
        <div className="billed-to">
          <div className="heading-edit-icon">
            <h5>Billed To</h5>
            <div className="edit-icon" onClick={handleOpen}>
              Edit
              <EditIcon />
            </div>
          </div>
          ...
          <div>
            ...
            <label htmlFor="Address">
              Address:<span style={{ fontWeight: "bold" }}>{address}</span>
            </label>{" "}
            <br />
            <label htmlFor="email">
            ...
            <br />
            <label htmlFor="Phone">
              Phone No:<span style={{ fontWeight: "bold" }}>{phone}</span>
            </label>
            <Modal
              open={open}
              onClose={handleClose}
            ...
            <div className="course-details-seal-logo">
              <div>
                ...
                <div className="billing-course-details">
                  <p className="billing-course-details-p-tag">
                    a. Name of the Course : Full Stack JavaScript Development
                    (Web & Mobile){" "}
                  </p>
                  <p className="billing-course-details-p-tag">
                    {" "}
                  ...
                  <p className="billing-course-details-p-tag">
                    {" "}
                    c. Commencement Date: {`${day}/${month}/${year}`}
                  </p>
                  <p className="billing-course-details-p-tag">
                    {" "}
                    d. Syllabus: HTML, CSS, JavaScript , React Native, React js,
                    Node, MySQL, GitHub & Azure.
                  </p>
                  <p className="billing-course-details-p-tag">
                    {" "}
                    e. Program Details: The above said course is a 6 Months
                    training program which is conducted offline at our training
                    centres or the facilities arranged by EduMetrix Learning
                    Solutions Pvt Ltd.
                  </p>
                </div>
              </div>
          ...
          <>
            <p>
              ...
              <span style={{ fontWeight: "bold" }}>
                ₹{parseInt(total) - parseInt(amountPaid)}
              </span>{" "}
              should be paid as 12 EMI.
            </p>
            <p>
              EMI Amount of{" "}
              <span style={{ fontWeight: "bold" }}>
                ₹{Math.floor((parseInt(total) - parseInt(amountPaid)) / 12)}{" "}
              </span>
              should be paid every month after Placement.{" "}
            </p>
          </>
        ) : (
          ""
              ...
              <div className="account-details">
                ...
                >
                  ...
                  <p style={{ fontWeight: "bold", textAlign: "right" }}>
                    Edumetrix Learning Solutions Pvt Ltd
                  </p>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
